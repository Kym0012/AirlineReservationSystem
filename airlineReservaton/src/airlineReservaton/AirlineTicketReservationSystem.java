...
public class AirlineTicketReservationSystem {
	public static void main(String[] args) {
        ...
        String[] city = {"Nairobi", "Mombasa", "Kisumu", "Eldoret"};
        String[] airportType = new String[] {"Single", "Multihop"};
        int[] arr = new int[2];
        int[] mark = new int[2];

        System.out.println("\n---------------------------------------------------------------------");
        System.out.println("--------WELCOME TO HIGHSKY AIRLINE RESERVATION--------");
        System.out.println("---------------------------------------------------------------------");
        System.out.println("For Flight Booking of : Nairobi-Mombasa-Kisumu-Eldoret");
        ...
        do {
            ...
            switch (ch) {
                case 1:
                    System.out.println("\n0.Nairobi\t\t1.Mombasa\t\t2.Kisumu\t\t3.Eldoret");
		...
		System.out.println("---------------HIGHSKY AIRLINE TICKET RESERVATION CENTER-----------");
		System.out.println("--------------------------------------------------------------------");
